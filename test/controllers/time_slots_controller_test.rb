...
class TimeSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post time_slots_url, params: { time_slot: { end_time: @time_slot.end_time, name: @time_slot.name, start_time: @time_slot.start_time } }
    end
  ...
  test "should update time_slot" do
    patch time_slot_url(@time_slot), params: { time_slot: { end_time: @time_slot.end_time, name: @time_slot.name, start_time: @time_slot.start_time } }
